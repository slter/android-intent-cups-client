...
import org.rainbrurpg.transparentcupsclient.HttpConnectionManagement;
...
public abstract class IppOperation {
	...
	L.d("in IppOp::sendRequest to URL " + url);
        HttpURLConnection connection = (HttpURLConnection) url.openConnection();
        mLastResponseCode = 0;
	L.d("in IppOp::sendRequest connected to printer : " + connection);
		...
		L.d("Setting HttpConnectionManagement manager");
                HttpConnectionManagement.handleHttpsUrlConnection((HttpsURLConnection) connection);
            }


	    L.d("Handling HttpConnectionManagement BasicAuth");
	    ...
	    L.d("in IppOp::sendRequest: about to connect to " + connection);
            connection.connect();
            ...
            // Prepare IPP result
	    L.d("in IppOp::sendRequest: preparing IPP result " + connection);
            ...
            mLastResponseCode = connection.getResponseCode();
            L.e("Caught exception while connecting to printer "+url+": ", e);
            throw e;
        } finally {
